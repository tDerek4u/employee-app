<x-admin-layout>
    ...
    <x-splade-table :for="$states" class=" border-spacing-24" >
        ...
        <Link href="{{ route('admin.states.destroy', $state) }}" method="DELETE" confirm
