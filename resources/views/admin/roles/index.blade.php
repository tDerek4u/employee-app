<x-admin-layout>
    ...
    <x-splade-table :for="$roles" class=" border-spacing-24" >
        ...
        <Link href="{{ route('admin.roles.destroy', $role) }}" method="DELETE" confirm
